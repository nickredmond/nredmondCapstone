...
//				if (nextConnection.getConnector() == secondNeuron){
//					nextConnection.setWeight(weight);
//				}
//			}
//			
//			for (NeuronConnection nextConnection : secondNeuron.getInputConnections()){
//				if (nextConnection.getConnector() == firstNeuron){
//					nextConnection.setWeight(weight);
//				}
//			}
//		}
